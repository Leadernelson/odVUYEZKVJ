...
class Settings(BaseSettings):
    ...
    ALLDEBRID_SUPPORTED_SOURCES: List[str] = ["wawacity", "free-telecharger", "darki-api", "wasource", "movix", "yggreborn", "tr4ker", "torr9", "c411"]
    ...
    TORBOX_SUPPORTED_SOURCES: List[str] = ["darki-api", "free-telecharger", "wasource", "movix", "webshare", "yggreborn", "tr4ker", "torr9", "c411"]
    ...
    PREMIUMIZE_SUPPORTED_SOURCES: List[str] = ["darki-api", "free-telecharger", "wasource", "movix", "yggreborn", "tr4ker", "torr9", "c411"]
    ...
    # Field Validators
    # ===========================
    @field_validator("WAWACITY_URL", "FREE_TELECHARGER_URL", "DARKI_API_URL", "MOVIX_URL", "WEBSHARE_URL", "PROXY_URL", "YGGREBORN_URL", "TR4KER_URL", "TORR9_URL", "C411_URL")
    @classmethod
